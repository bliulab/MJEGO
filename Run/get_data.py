...
import Utils.params2 as params
import Utils.utils
from Dataset.Dataset2 import load_dataset # 数据集加载
from Models.idea333 import GCN as Model  # 模型定义
...
edge_types = list(params.edge_types1)
